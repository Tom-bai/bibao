<template>
    <div class="trade-right">
        ...
        <div class="kline-component" :class="posBool?'kline-pos':'kline-info'">
            <router-link target="_blank" to="/trade/full" style="position: absolute;right: 10px;top: 2px;color: white">
                <span>全屏K线>> </span>
            </router-link>
            ...
            <el-row>
                ...
                <el-col :span="8" class="pr-15">
                    <div class="grid-content pd-10">
                        <div class="sale-titles">智能止损</div>
                            ...
                            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
                                <el-form-item prop="name">
                                    <el-input v-model="ruleForm.name" :placeholder="$t('REQUIRE_PHONE_EMAIL')" class="c2b-input">
                                        <span slot="prefix" class="c2b-input-text-left">触发价</span>
                                ...
                                <el-form-item prop="name">
                                    <el-input v-model="ruleForm.name" :placeholder="$t('PASSWORD_PLACE')" class="c2b-input">
                                        <span slot="prefix" class="c2b-input-text-left">价格</span>
                                        <span slot="suffix" class="c2b-input-text">BTC</span>
                                    </el-input>
                                </el-form-item>
                                <el-form-item prop="name">
                                    <el-input v-model="ruleForm.name" :placeholder="$t('PASSWORD_PLACE')" class="c2b-input">
                                        <span slot="prefix" class="c2b-input-text-left">数量</span>
                                        <span slot="suffix" class="c2b-input-text">BTC</span>
                                    </el-input>
                                </el-form-item>
                ...
                <el-col :span="8" class="pl-15 pr-15">
                    <div class="grid-content pd-10">
                        <div class="sale-titles">智能止盈</div>
                        <div class="sale-title">{{'AVALIABLE'|t}}
                        ...
                        <div class="form-wrap">
                            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
                                ...
                                <el-form-item prop="name">
                                    <el-input v-model="ruleForm.name" :placeholder="$t('PASSWORD_PLACE')" class="c2b-input">
                                        <span slot="prefix" class="c2b-input-text-left">委托价</span>
                                        <span slot="suffix" class="c2b-input-text">BTC</span>
                                    </el-input>
                                </el-form-item>
                                <el-form-item prop="name">
                        ...
                        <div class="trade-list list list-sell">
                            <div class="trade-item" v-for="(item,key) of dataList" :key=key>
                                ...
                                <div class="trade-info trade-info-bar">
                                    <span class="bar-text">{{item.val|Fixed(7)}}</span>
                                    <div class="bar">
                                        <span :style="'width: '+item.ps+'%'"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
