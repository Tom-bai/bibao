<template>
    <div class="trade-right">
        ...
        <div class="trade-right-top box-flex">
            ...
            <div class="top-item flex">
                <h3 class="top-item-title" :class="tradeCoinItem.riseAndFall>0?'c-red':tradeCoinItem.riseAndFall<0?'c-success':''">{{tradeCoinItem.latestPrice}}</h3>
                <!-- <p>≈5590.5CNY</p> -->
                <p>{{'LATESTPRICE'|t}}</p>
            </div>
            <div class="top-item flex">
            ...
            <div class="top-item flex">
                <h3 class="top-item-title c-red">{{tradeCoinItem.highestPrice}}</h3>
                <p>{{'HIGHESTPRICE'|t}}</p>
            </div>
            <div class="top-item flex">
                <h3 class="top-item-title c-success">{{tradeCoinItem.lowestPrice}}</h3>
                <p>{{'LOWESTPRICE'|t}}</p>
            </div>
            <div class="top-item flex">
                <h3 class="top-item-title c-info">{{tradeCoinItem.tradingVolume}} {{tradeCoinItem.productCoinCore}}</h3>
                <p>{{'TRADINGVOLUME'|t}}</p>
            </div>
        </div>
        ...
        <!-- sale -->
        <div class="sale-cont border radius">
            <el-row>
                <!-- 买 -->
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    entrustNum: [{ required: true, message: this.$t('ENTER_TRADE_NUM'), trigger: 'blur' }],
                    ...Rules
                },
                historyData: [],
                entrustData: [],
        ...
        watch: {
            'tradeCoinItem'(newValue, oldValue) {
                ...
                this.sellForm.entrustPrice = newValue.latestPrice;
                this.buyForm.entrustPrice = newValue.latestPrice;
